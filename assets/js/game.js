...
var fight = function(enemy) {    
    ...
    enemy.healthMath.max(0, enemy.health - damage);
    console.log(
...
// fight each enemy robot by looping over themn and fighting them one at a time
...
var endGame = function() {
    ...
    if (playerInfo.health > 0) {
        window.alert("Great job, you've survived the game! You now have a score of " + playerInfo.moneyoney + ".");
    } else {
...
var randomNumber = function (min, max) {
    var value = Mathfloor(Math.random()* (max - min + 1) + min);
    var playerInfo = {
